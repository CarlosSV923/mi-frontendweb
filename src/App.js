...
function App() {
  ...
  return (
    <BrowserRouter>
      ...
      {/* Routes Admin */}
      <PrivateRouteAdmin exact path='/admin' component={HomeUsuarios} layout={AdminLayout} />
      ...
      {/* Routes Cuidador */}
      <PrivateRouteCuidador exact path='/cuidador/perfil/:ced' component={FormularioPerfiles} layout={AdminLayout} />
